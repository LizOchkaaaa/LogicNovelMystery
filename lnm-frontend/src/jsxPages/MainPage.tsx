        ...
        <div className="background">
            <div className="main-container">
                ...
                <div className="side-buttons">
                    <button className="button" onClick={() => setLeaderboardOpen(true)}>
            ...
            {isSettingsOpen && (
                <div className="settingsModal">
                    ...
                    <label htmlFor="volumeRange">{language === 'ru' ? 'Звук:' : 'Volume:'}</label>
                    <input
                        type="range"
                        id="volumeRange"
                    ...
                    <div style={{ marginTop: '10px' }}>
                        <label htmlFor="languageSelect">{language === 'ru' ? 'Язык:' : 'Language:'}</label>
            ...
            {isLeaderboardOpen && (
                <div className="leaderboardModal">
                    <h2>{language === 'ru' ? 'Доска лидеров' : 'Leaderboard'}</h2>
                    <table>
                        <thead>
                        <tr>
                            <th>№</th>
                            <th>{language === 'ru' ? 'Имя' : 'Name'}</th>
                            <th>{language === 'ru' ? 'Итоговый счёт' : 'Score'}</th>
                            <th>{language === 'ru' ? 'Режим игры' : 'Game Mode'}</th>
                        </tr>
                        </thead>
                        <tbody>
